...
function output = muscleModel_Combined_v2(t,Fs,input,modelParameter,recruitmentType)
%--------------------------------------------------------------------------
...
alpha_Pi = modelParameter.alpha;
Pi = alpha_Pi; % adjusted peak twitch amplitude
